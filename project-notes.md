...
- **Anthropic Claude Sonnet 4.6** (claude-sonnet-4-5 or latest — confirm exact API model string at runtime)
...
- **Phase 1 (family only):** Claude Sonnet 4.6 — quality over cost, negligible usage
...
## AI Model Strategy
- **All generation (questions, commentary, onboarding, chat):** `claude-sonnet-4-6` (Claude Sonnet 4.6) — family phase
...
3. **Chat** — Session 18's freeform "ask me anything about this passage." Stateful. Pulls message thread from `messages` table. Always `claude-sonnet-4-6`.
...
#### Token Strategy
- **Tim:** `claude-sonnet-4-6`, one call, all 5 questions, full context — no compromise.
